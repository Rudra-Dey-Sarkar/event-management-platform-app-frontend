...
async function AddEventData(data: EventDataType, setIsLoading: React.Dispatch<React.SetStateAction<boolean>>, setAE: any) {
...
function AddEvent({ user, setAE }: { user: UserDataType | any[], setAE: React.Dispatch<React.SetStateAction<boolean>> }) {
    ...
    return (
        <div className='relative sm:w-fit sm:h-[90vh] overflow-y-auto'>
            {isActive === true &&
            ...
            <form
                ...
                onSubmit={handleSubmit((data) => AddEventData(data, setIsLoading, setAE))}>
