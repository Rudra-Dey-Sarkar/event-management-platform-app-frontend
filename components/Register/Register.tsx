...
async function RegisterUser(data: UserDataType, setIsPresent: any, setIsLoading: React.Dispatch<React.SetStateAction<boolean>>, setIsActive:any) {
  setIsLoading(true);
...
function Register() {
  ...
  return (
    <form 
    onSubmit={handleSubmit((data) => RegisterUser(data, setIsPresent, setIsLoading, setIsActive))}
